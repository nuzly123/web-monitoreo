        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="?page=sql_ciudades" method="post">
                    <input type="hidden" name="newCiudad"/>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="nameBasic" class="form-label text-left">Nombre Ciudad</label>
                            <input type="text" name="nombreCiudad" class="form-control" placeholder="Enter Name"/>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="nuevaCiudad">Añadir</button>
                </form>
            </div>
        </div>
    </div>
