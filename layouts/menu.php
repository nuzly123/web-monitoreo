<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.php" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="images/logoAEROSOSA.svg" alt="Logo Sosa" />
            </span>
            <span class="app-brand-text demo text-body fw-bolder">AeroSosa</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Monitoreo</span>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">Empleados</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                        <div data-i18n="User interface">Configuración</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="Basic">Aeronaves</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="html/ui-accordion.html" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="ui-alerts.html" class="menu-link">
                        <div data-i18n="Alerts">Rutas</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="ui-buttons.html" class="menu-link">
                        <div data-i18n="Buttons">Permisos</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="html/ui-accordion.html" class="menu-link">
                        <div data-i18n="Accordion">Buscar Usuario</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="ui-badges.html" class="menu-link">
                        <div data-i18n="Badges">Roles</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="ui-buttons.html" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="?page=aeropuertos" class="menu-link">
                        <div data-i18n="Text Divider">Aeropuertos</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="?page=ciudades" class="menu-link">
                        <div data-i18n="Perfect Scrollbar">Ciudades</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="?page=departamentos" class="menu-link">
                        <div data-i18n="Text Divider">Departamentos</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="?page=estaciones" class="menu-link">
                        <div data-i18n="Text Divider">Estaciones</div>
                    </a>
                </li>
            </ul>
        </li>
